...
export default function PropertyHeader({ propertyName, propertyId, propertySlug }: PropertyHeaderProps) {
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        'absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-gold/50 to-transparent transition-opacity duration-500',
      ...
      <div className="max-w-[1600px] mx-auto px-8 lg:px-12">
        <div className={cn(
          ...
          <Link href="/" className="flex items-center group relative">
            <span
              className={cn(
                'text-[26px] tracking-[-0.02em] font-display transition-all duration-500',
                isScrolled
            ...
            <span className={cn(
              ...
              isScrolled
                ? 'w-0 bg-gold/50 group-hover:w-full'
          ...
          <nav className="hidden lg:flex items-center">
            ...
            <div className={cn(
              ...
              isScrolled
                ? 'bg-gradient-to-b from-transparent via-ink/12 to-transparent'
          ...
          {navItems.map((item, index) => (
            <button
              ...
              className={cn(
                ...
                isScrolled
                  ? 'text-ink hover:bg-gold/[0.06] hover:text-gold'
